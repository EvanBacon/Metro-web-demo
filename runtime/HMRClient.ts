...
let pendingLogs: Array<[LogLevel, Array<any>]> = [];
...
const HMRClient: HMRClientNativeInterface = {
  ...
  registerBundle(requestUrl: string) {
    console.log("hmr register:", requestUrl);
    invariant(hmrClient, "Expected HMRClient.setup() call at startup.");
  ...
  setup(
    ...
    console.log("hmr setup:", platform, bundleEntry, host, port, isEnabled);
